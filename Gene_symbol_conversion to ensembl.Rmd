...
```{r}
gene_symbols_mouse <- readLines("diff_exp_gene_list.txt")
...
```{r}
write.table(converted_genes_mouse, file = "converted_DEG_genes_mouse.txt", sep = "\t", quote = FALSE, row.names = FALSE)
